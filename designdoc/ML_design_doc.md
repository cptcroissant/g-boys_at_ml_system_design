## Дизайн ML-системы "Предсказатель заинтересованности клиента в рекламе" <MVP> <g-boys>
...
- Бизнес-цель   
Создание инструмента для ранжирования рекламных акций под профиль клиента. В результате - показываем пользователю самую валидную для него рекламу, с максимальной вероятностью клика.  
- Почему станет лучше, чем сейчас, от использования ML
В рамках цифровизации маркетинга мы сможем обрабатывать бОльшее количество данных за меньшую единицу времени. Выявлять неочевидные интересы и паттерны клиентов, максимизироать продажи товаров, воздействую на заинтересованную категорию лиц.
- Что будем считать успехом итерации с точки зрения бизнеса  
1.  Назначение проекта заключается в создании программного модуля, позволяющего принимать выгруженные данные из BI системы в формате csv, проводить обработку табличных данных, строить модель, определяющую отточных клиентов, выгружать ранжированный список наиболее склонных к просмотру данного предложения.
