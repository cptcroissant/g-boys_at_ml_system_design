...
- Назначение проекта заключается в:

- Создании программного модуля, позволяющего  проводить обработку табличных данных пользователей сервиса, строить модель, определяющую для каждого пользователя список потенциальных партнеров, 
...
Протестировать возможность и реализовать алгоритм выявления потенциальных партнеров для пользователя сервиса знакомств. 
...
Решается задача построения рекомендательной системы и матчинга. 
...
•	Помощь в обработке и передачи данных о ходе проведений АБ-тестов и о их результатах
...
•	Разработка дополнительных метрик качества в части бизнес-целей 
